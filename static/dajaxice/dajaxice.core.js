...
var Dajaxice = {
    ...
    edit_event: function(callback_function, argv, custom_settings){
        return Dajaxice.call('portal.edit_event', 'POST', callback_function, argv, custom_settings);
    },

    reload_events: function(callback_function, argv, custom_settings){
    ...
    save_event: function(callback_function, argv, custom_settings){
        return Dajaxice.call('portal.save_event', 'POST', callback_function, argv, custom_settings);
    },

    save_edited_event: function(callback_function, argv, custom_settings){
        return Dajaxice.call('portal.save_edited_event', 'POST', callback_function, argv, custom_settings);
    },

    save_update: function(callback_function, argv, custom_settings){
        return Dajaxice.call('portal.save_update', 'POST', callback_function, argv, custom_settings);
    },

    add_update: function(callback_function, argv, custom_settings){
        return Dajaxice.call('portal.add_update', 'POST', callback_function, argv, custom_settings);
    },

    delete_event: function(callback_function, argv, custom_settings){
        return Dajaxice.call('portal.delete_event', 'POST', callback_function, argv, custom_settings);
    },

    reload: function(callback_function, argv, custom_settings){
        return Dajaxice.call('portal.reload', 'POST', callback_function, argv, custom_settings);
    },
    ...
    leave_event: function(callback_function, argv, custom_settings){
        return Dajaxice.call('portal.leave_event', 'POST', callback_function, argv, custom_settings);
    },
    ...
    add_event: function(callback_function, argv, custom_settings){
        return Dajaxice.call('portal.add_event', 'POST', callback_function, argv, custom_settings);
    },

    save_edited_update: function(callback_function, argv, custom_settings){
        return Dajaxice.call('portal.save_edited_update', 'POST', callback_function, argv, custom_settings);
    }
...
,
    ...
    call: function(dajaxice_function, method, dajaxice_callback, argv, custom_settings)
    {
        ...
        var send_data = 'argv='+encodeURIComponent(JSON.stringify(argv)),
            ...
            endpoint = '/odia/dajaxice/'+dajaxice_function+'/';
